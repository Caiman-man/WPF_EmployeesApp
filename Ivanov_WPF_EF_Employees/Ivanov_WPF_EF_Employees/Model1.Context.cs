...
namespace Ivanov_WPF_EF_Employees
{
    ...
    public partial class Ivanov_EmployeesEntities : DbContext
    {
        public Ivanov_EmployeesEntities()
            : base("name=Ivanov_EmployeesEntities")
        {
        }
        ...
        public virtual int delete_employees(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
